...
const [isCreateLinksModal, setIsCreateLinksModal ] = useState(false)
...
function openCreateLinksModal(){
    setIsCreateLinksModal(true)
}

function closeCreateLinksModal(){
    setIsCreateLinksModal(false)
}
    ...
    return (
        <div className=" max-w-6xl px-6 py-10 mx-auto space-y-8">
            ...
            {isCreateLinksModal && (
                <CreateLinksModal
                closeCreateLinksModal={closeCreateLinksModal}
                />
            )}
